...
const I18N = {
  ko: {
    ...
    info:{ host:'주최', target:'참가대상', method:'접수방법', prize:'시상내역', cost:'비용', fee:'관람료' },
  ...
  en: {
    ...
    info:{ host:'Host', target:'Eligibility', method:'How to Apply', prize:'Prize', cost:'Cost', fee:'Admission' },
  ...
  zh: {
    ...
    info:{ host:'主办方', target:'参与对象', method:'报名方式', prize:'奖励详情', cost:'费用', fee:'门票' },
  ...
  ja: {
    ...
    info:{ host:'主催', target:'参加対象', method:'応募方法', prize:'賞品内容', cost:'費用', fee:'観覧料' },
...
const CONTENTS = [
  // 디자인
  { id:'ux-contest', tags:['디자인','공모전'], title:{ko:'2026 UI/UX 디자인 공모전', en:'2026 UI/UX Design Contest', zh:'2026 UI/UX设计大赛', ja:'2026 UI/UXデザインコンテスト'}, deadline:'~05.20', urgent:false, icon:'iconoir:trophy', desc:{ko:'사용자 경험을 새롭게 바꿀 창의적인 UI/UX 디자인을 기다립니다.', en:'We are looking for creative UI/UX designs that reinvent the user experience.', zh:'期待能够革新用户体验的创意UI/UX设计。', ja:'ユーザー体験を刷新する創造的なUI/UXデザインをお待ちしています。'}, img:'https://images.unsplash.com/photo-1502810190503-8303352d0dd1?w=200&h=200&fit=crop&q=80' },
  { id:'brand-exhibit', tags:['디자인','문화/예술'], title:{ko:'브랜드 아이덴티티 디자인 전시회', en:'Brand Identity Design Exhibition', zh:'品牌形象设计展', ja:'ブランドアイデンティティデザイン展'}, deadline:'~05.28', urgent:false, icon:'iconoir:design-pencil', desc:{ko:'학생들이 직접 만든 브랜드 아이덴티티 작업을 한자리에서 만나 보세요.', en:'Brand identity work made by students, all in one place.', zh:'一次看遍学生亲手打造的品牌形象作品。', ja:'学生が手がけたブランドアイデンティティ作品を一堂に。'}, img:'https://images.unsplash.com/photo-1561070791-2526d30994b5?w=200&h=200&fit=crop&q=80' },
  { id:'typo-study', tags:['디자인','스터디'], title:{ko:'타이포그래피 디자인 스터디 모집', en:'Typography Design Study Group', zh:'招募字体设计学习小组成员', ja:'タイポグラフィデザインスタディ募集'}, deadline:'~04.25', urgent:true, icon:'iconoir:group', desc:{ko:'매주 한 편씩 글자를 뜯어보며 타이포그래피 감각을 기릅니다.', en:'Pull apart one typeface a week and build your typography eye.', zh:'每周拆解一款字体，培养排版感觉。', ja:'毎週1書体を読み解き、タイポグラフィの感覚を養います。'}, img:'https://images.unsplash.com/photo-1493246507139-91e8fad9978e?w=200&h=200&fit=crop&q=80' },
  // IT / 개발
  ...
  { id:'campus-app', tags:['IT / 개발','프로젝트'], title:{ko:'캠퍼스 앱 개발 프로젝트 팀원 모집', en:'Campus App Dev Project Team', zh:'招募校园App开发项目成员', ja:'キャンパスアプリ開発プロジェクトメンバー募集'}, deadline:'~05.12', urgent:false, icon:'iconoir:code', desc:{ko:'기획부터 배포까지 직접 해보는 캠퍼스 앱 개발 프로젝트입니다.', en:'Build a campus app end to end, from planning to release.', zh:'从企划到上线，亲手完成校园App开发项目。', ja:'企画から公開まで自分たちで進めるキャンパスアプリ開発です。'}, img:'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=200&h=200&fit=crop&q=80' },
  // 영상 / 미디어
  { id:'short-film', tags:['영상 / 미디어','공모전'], title:{ko:'대학생 단편 영상 공모전', en:'College Short Film Contest', zh:'大学生短片竞赛', ja:'大学生短編映像コンテスト'}, deadline:'~05.31', urgent:false, icon:'iconoir:play', desc:{ko:'5분 안에 담아낸 당신의 이야기를 보여주세요.', en:'Tell your story in five minutes or less.', zh:'用五分钟讲出你的故事。', ja:'5分以内に収めたあなたの物語を見せてください。'}, img:'https://images.unsplash.com/photo-1552581234-26160f608093?w=200&h=200&fit=crop&q=80' },
  { id:'vlog-study', tags:['영상 / 미디어','스터디'], title:{ko:'브이로그 크리에이터 스터디 모집', en:'Vlog Creator Study Group', zh:'招募Vlog创作者学习小组成员', ja:'Vlogクリエイタースタディ募集'}, deadline:'~04.28', urgent:true, icon:'iconoir:play', desc:{ko:'촬영과 편집을 함께 연습하며 채널을 키워 가는 모임입니다.', en:'Practice shooting and editing together while growing a channel.', zh:'一起练习拍摄剪辑，共同经营频道。', ja:'撮影と編集を一緒に練習し、チャンネルを育てる集まりです。'}, img:'https://images.unsplash.com/photo-1595872018818-97555653a011?w=200&h=200&fit=crop&q=80' },
  { id:'media-art', tags:['영상 / 미디어','행사'], title:{ko:'미디어아트 전시 & 상영회', en:'Media Art Exhibition & Screening', zh:'媒体艺术展览暨放映会', ja:'メディアアート展示&上映会'}, deadline:'~05.16', urgent:false, icon:'iconoir:play', desc:{ko:'빛과 소리로 만든 작품을 직접 보고 들을 수 있는 자리입니다.', en:'See and hear works built from light and sound.', zh:'现场观赏由光与声构成的作品。', ja:'光と音でつくられた作品を体感できる場です。'}, img:'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=200&h=200&fit=crop&q=80' },
  // 마케팅
  { id:'mkt-supporters', tags:['마케팅','대외활동'], title:{ko:'대학생 마케팅 서포터즈 15기 모집', en:'15th College Marketing Supporters', zh:'第15期大学生市场营销支持者招募', ja:'大学生マーケティングサポーターズ15期募集'}, deadline:'~05.09', urgent:false, icon:'iconoir:megaphone', desc:{ko:'브랜드 캠페인을 직접 기획하고 실행해 보는 6개월 활동입니다.', en:'Plan and run brand campaigns yourself over six months.', zh:'为期六个月，亲自策划并执行品牌活动。', ja:'ブランドキャンペーンを自ら企画・実行する6か月の活動です。'}, img:'https://images.unsplash.com/photo-1587620962725-abab7fe55159?w=200&h=200&fit=crop&q=80' },
  { id:'sns-contest', tags:['마케팅','공모전'], title:{ko:'SNS 콘텐츠 마케팅 공모전', en:'SNS Content Marketing Contest', zh:'SNS内容营销大赛', ja:'SNSコンテンツマーケティングコンテスト'}, deadline:'~05.23', urgent:false, icon:'iconoir:megaphone', desc:{ko:'짧은 콘텐츠 하나로 사람을 움직여 보세요.', en:'Move people with a single short piece of content.', zh:'用一条短内容打动人心。', ja:'短いコンテンツ一つで人を動かしてみてください。'}, img:'https://images.unsplash.com/photo-1533750349088-cd871a92f312?w=200&h=200&fit=crop&q=80' },
  { id:'brand-study', tags:['마케팅','스터디'], title:{ko:'브랜드 마케팅 전략 스터디', en:'Brand Marketing Strategy Study', zh:'品牌营销战略学习小组', ja:'ブランドマーケティング戦略スタディ'}, deadline:'~04.22', urgent:true, icon:'iconoir:group', desc:{ko:'잘된 브랜드 사례를 뜯어보며 전략의 언어를 익힙니다.', en:'Break down strong brands and learn the language of strategy.', zh:'拆解优秀品牌案例，掌握战略语言。', ja:'優れたブランド事例を分析し、戦略の言葉を身につけます。'}, img:'https://images.unsplash.com/photo-1552664730-d307ca884978?w=200&h=200&fit=crop&q=80' },
  // 여행 / 캠핑
  { id:'jeju-trip', tags:['여행 / 캠핑','번개'], title:{ko:'제주도 2박 3일 번개 여행', en:'3-Day Jeju Island Meetup Trip', zh:'济州岛3天2夜快闪旅行', ja:'済州島2泊3日突発旅行'}, deadline:'~05.10', urgent:false, icon:'iconoir:map', desc:{ko:'비행기표만 있으면 됩니다. 일정은 함께 정해요.', en:'Just bring a plane ticket. We plan the rest together.', zh:'只要有机票就行，行程一起商量。', ja:'航空券だけあれば大丈夫。日程は一緒に決めましょう。'}, img:'https://images.unsplash.com/photo-1628411848698-e3b3249a272a?w=200&h=200&fit=crop&q=80' },
  { id:'autumn-camp', tags:['여행 / 캠핑','번개'], title:{ko:'가을맞이 대학생 캠핑 모임', en:'Autumn Camping Meetup for Students', zh:'迎秋大学生露营聚会', ja:'秋の大学生キャンプ集会'}, deadline:'~05.18', urgent:false, icon:'iconoir:map', desc:{ko:'선선한 밤, 불 앞에 둘러앉아 이야기 나누는 캠핑입니다.', en:'A cool night, a fire, and good conversation.', zh:'凉爽夜晚，围着篝火聊天的露营。', ja:'涼しい夜、焚き火を囲んで語らうキャンプです。'}, img:'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=200&h=200&fit=crop&q=80' },
  { id:'backpack-club', tags:['여행 / 캠핑','대외활동'], title:{ko:'국내 배낭여행 동아리원 모집', en:'Domestic Backpacking Club Members Wanted', zh:'招募国内背包旅行社团成员', ja:'国内バックパック旅行サークル員募集'}, deadline:'~04.27', urgent:true, icon:'iconoir:group', desc:{ko:'방학마다 배낭 하나 메고 국내 곳곳을 걷는 동아리입니다.', en:'Every break, one backpack and a new corner of the country.', zh:'每逢假期背上背包走遍国内各地的社团。', ja:'長期休みごとにバックパック一つで国内を歩くサークルです。'}, img:'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=200&h=200&fit=crop&q=80' },
  // 사진
  { id:'campus-photo', tags:['사진','공모전'], title:{ko:'캠퍼스 사진 공모전 - 나의 대학생활', en:'Campus Photo Contest — My College Life', zh:'校园摄影大赛——我的大学生活', ja:'キャンパス写真コンテスト —私の大学生活'}, deadline:'~05.25', urgent:false, icon:'iconoir:camera', desc:{ko:'익숙한 교정에서 발견한 낯선 순간을 담아 주세요.', en:'Capture an unfamiliar moment on a familiar campus.', zh:'捕捉熟悉校园中的陌生瞬间。', ja:'見慣れたキャンパスで見つけた新鮮な瞬間を収めてください。'}, img:'https://images.unsplash.com/photo-1478737270239-2f02b77fc618?w=200&h=200&fit=crop&q=80' },
  { id:'film-club', tags:['사진','스터디'], title:{ko:'필름 사진 동호회 신입 모집', en:'Film Photography Club New Members', zh:'招募胶片摄影社新成员', ja:'フィルム写真同好会新入部員募集'}, deadline:'~04.29', urgent:true, icon:'iconoir:group', desc:{ko:'직접 찍고 현상하며 필름의 기다림을 배웁니다.', en:'Shoot, develop, and learn the patience of film.', zh:'亲手拍摄冲洗，体会胶片的等待。', ja:'自分で撮り、現像し、フィルムの待つ時間を学びます。'}, img:'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=200&h=200&fit=crop&q=80' },
  { id:'photo-walk', tags:['사진','번개'], title:{ko:'사진작가와 함께하는 출사 모임', en:'Photo Walk with a Pro Photographer', zh:'与摄影师一起的外拍活动', ja:'写真家と行く撮影会'}, deadline:'~05.14', urgent:false, icon:'iconoir:camera', desc:{ko:'현직 작가와 함께 걸으며 그 자리에서 피드백을 받습니다.', en:'Walk with a working photographer and get feedback on the spot.', zh:'与职业摄影师同行，当场获得点评。', ja:'現役作家と歩きながら、その場でフィードバックをもらいます。'}, img:'https://images.unsplash.com/photo-1560421683-6856ea585c78?w=200&h=200&fit=crop&q=80' },
  // 음악
  { id:'song-festival', tags:['음악','공모전'], title:{ko:'대학가요제 참가팀 모집', en:'College Song Festival Team Recruitment', zh:'大学歌谣祭参赛队伍招募', ja:'大学歌謡祭参加チーム募集'}, deadline:'~05.30', urgent:false, icon:'iconoir:music-note', desc:{ko:'무대에 설 준비가 된 팀을 찾습니다.', en:'Looking for teams ready to take the stage.', zh:'寻找准备好登台的队伍。', ja:'ステージに立つ準備ができたチームを探しています。'}, img:'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=200&h=200&fit=crop&q=80' },
  { id:'band-session', tags:['음악','대외활동'], title:{ko:'밴드 동아리 세션 멤버 모집', en:'Band Club Session Member Recruitment', zh:'乐队社团招募伴奏成员', ja:'バンドサークルセッションメンバー募集'}, deadline:'~04.24', urgent:true, icon:'iconoir:group', desc:{ko:'합주할 사람이 필요한 밴드와 연주할 곳이 필요한 사람을 잇습니다.', en:'Connecting bands who need players with players who need a stage.', zh:'为需要伴奏的乐队和想演出的人牵线。', ja:'メンバーを探すバンドと演奏の場を探す人をつなぎます。'}, img:'https://images.unsplash.com/photo-1493711662062-fa541adb3fc8?w=200&h=200&fit=crop&q=80' },
  { id:'busking-volunteer', tags:['음악','행사'], title:{ko:'버스킹 페스티벌 자원봉사자 모집', en:'Busking Festival Volunteer Recruitment', zh:'街头表演节志愿者招募', ja:'ストリートライブフェスティバルボランティア募集'}, deadline:'~05.17', urgent:false, icon:'iconoir:music-note', desc:{ko:'무대 뒤에서 축제를 함께 만들 사람을 찾습니다.', en:'Help build the festival from behind the stage.', zh:'招募在幕后共同打造音乐节的伙伴。', ja:'舞台裏でフェスをともにつくる仲間を募集します。'}, img:'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?w=200&h=200&fit=crop&q=80' },
  // 창업
  { id:'startup-idea', tags:['창업','공모전'], title:{ko:'전국 대학생 창업 아이디어 공모전', en:'National College Startup Idea Contest', zh:'全国大学生创业创意大赛', ja:'全国大学生起業アイデアコンテスト'}, deadline:'~06.05', urgent:false, icon:'iconoir:light-bulb', desc:{ko:'아이디어 한 장이면 충분합니다. 나머지는 함께 다듬어요.', en:'One page of an idea is enough. We refine the rest together.', zh:'一页创意就够，剩下的一起打磨。', ja:'アイデア1枚で十分です。残りは一緒に磨きましょう。'}, img:'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=200&h=200&fit=crop&q=80' },
  { id:'startup-intern', tags:['창업','대외활동'], title:{ko:'스타트업 인턴십 프로그램 모집', en:'Startup Internship Program', zh:'创业公司实习项目招募', ja:'スタートアップインターンシッププログラム募集'}, deadline:'~05.02', urgent:true, icon:'iconoir:light-bulb', desc:{ko:'초기 스타트업에서 실제 문제를 맡아 보는 인턴십입니다.', en:'An internship owning real problems at an early-stage startup.', zh:'在初创公司负责真实课题的实习。', ja:'初期スタートアップで実際の課題を担うインターンです。'}, img:'https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=200&h=200&fit=crop&q=80' },
  { id:'prestartup-team', tags:['창업','프로젝트'], title:{ko:'예비창업패키지 도전 팀원 모집', en:'Pre-Startup Package Challenge Team', zh:'招募预备创业扶持项目挑战团队成员', ja:'予備創業パッケージ挑戦チームメンバー募集'}, deadline:'~05.21', urgent:false, icon:'iconoir:light-bulb', desc:{ko:'예비창업패키지 지원을 함께 준비할 팀원을 찾습니다.', en:'Looking for teammates to prepare a startup grant application together.', zh:'寻找一起准备创业资助申请的队友。', ja:'予備創業パッケージの申請を一緒に準備する仲間を探します。'}, img:'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=200&h=200&fit=crop&q=80' },
  // 인문 / 사회
  { id:'classics-reading', tags:['인문 / 사회','스터디'], title:{ko:'인문학 고전 독서 토론 모임', en:'Humanities Classics Reading Group', zh:'人文经典读书讨论会', ja:'人文学古典読書討論会'}, deadline:'~04.26', urgent:true, icon:'iconoir:book', desc:{ko:'한 달에 한 권, 오래 살아남은 책을 함께 읽습니다.', en:'One book a month, chosen from those that have lasted.', zh:'每月一本，共读经得起时间的书。', ja:'月に一冊、長く読み継がれてきた本を一緒に読みます。'}, img:'https://images.unsplash.com/photo-1524578271613-d550eacf6090?w=200&h=200&fit=crop&q=80' },
  { id:'social-innovation', tags:['인문 / 사회','공모전'], title:{ko:'사회혁신 아이디어 공모전', en:'Social Innovation Idea Contest', zh:'社会创新创意大赛', ja:'社会革新アイデアコンテスト'}, deadline:'~05.29', urgent:false, icon:'iconoir:book', desc:{ko:'가까운 곳의 문제부터 해결해 보는 아이디어를 기다립니다.', en:'We welcome ideas that start with problems close to home.', zh:'期待从身边问题入手的解决方案。', ja:'身近な課題から解決するアイデアをお待ちしています。'}, img:'https://images.unsplash.com/photo-1529333166437-7750a6dd5a70?w=200&h=200&fit=crop&q=80' },
  { id:'edu-volunteer', tags:['인문 / 사회','대외활동'], title:{ko:'교육 봉사활동 서포터즈 모집', en:'Education Volunteer Supporters', zh:'教育志愿服务支持者招募', ja:'教育ボランティア活動サポーターズ募集'}, deadline:'~05.06', urgent:false, icon:'iconoir:group', desc:{ko:'주 1회, 지역 아동에게 공부를 가르치는 봉사활동입니다.', en:'Teach local children once a week as a volunteer.', zh:'每周一次，为社区儿童辅导功课的志愿活动。', ja:'週1回、地域の子どもに勉強を教えるボランティアです。'}, img:'https://images.unsplash.com/photo-1509824227185-9c5a01ceba0d?w=200&h=200&fit=crop&q=80' },
...
const COMM_POSTS = [
  { id:'cp01', community:'school', author:0, hours:2,  like:24, comment:11, title:{ko:'중앙도서관 시험기간 자리 상황 공유해요',en:'Sharing library seat availability during finals',zh:'分享考试期间中央图书馆座位情况',ja:'中央図書館の試験期間の座席状況を共有します'}, body:{ko:'3층 열람실은 오전 9시면 거의 찹니다. 2층 자유석은 점심시간 직후가 제일 여유로웠어요. 지하 1층은 자리는 많은데 콘센트가 적으니 노트북 쓰실 분은 참고하세요.', en:'The third-floor reading room fills up by 9am. Second-floor open seats are emptiest right after lunch. B1 has plenty of seats but few outlets, so keep that in mind if you use a laptop.', zh:'三楼阅览室九点就快满了。二楼自由座位在午饭后最宽松。地下一层座位多但插座少，用笔记本的同学请注意。', ja:'3階の閲覧室は午前9時にはほぼ埋まります。2階の自由席は昼休み直後が一番空いています。地下1階は席は多いのですがコンセントが少ないので、ノートPCを使う方はご注意を。'} },
  { id:'cp02', community:'school', author:2, hours:7,  like:18, comment:9,  title:{ko:'이번 학기 교양 추천 좀 부탁드려요',en:'Any recommendations for electives this term?',zh:'求推荐这学期的通识课',ja:'今学期の教養科目のおすすめを教えてください'}, body:{ko:'1학기에 들었던 교양 중에 만족스러웠던 걸 정리해 봤어요. 과제량이 적당하면서 배우는 게 있는 수업 위주로 골랐습니다. 혹시 추천할 만한 수업 있으면 댓글 부탁드려요.', en:'Here are the electives I actually enjoyed last term, picked for a fair workload and real takeaways. Drop a comment if you have one to recommend.', zh:'整理了上学期修过的比较满意的通识课，主要挑作业量适中又学得到东西的。有推荐的课欢迎留言。', ja:'前期に受けた教養科目でよかったものをまとめました。課題量が適度で学びのある授業を中心に選んでいます。おすすめがあればコメントお願いします。'} },
  { id:'cp03', community:'school', author:1, hours:26, like:31, comment:14, title:{ko:'학교 축제 부스 운영 후기',en:'Recap of running a festival booth',zh:'校庆摆摊经营后记',ja:'学園祭ブース運営のレビュー'}, body:{ko:'부스 운영은 처음이었는데 준비물보다 동선이 훨씬 중요하더라고요. 사람이 몰리는 시간대가 정해져 있어서 그때 인원을 몰아 두는 게 나았습니다. 다음에 하실 분들께 도움이 되면 좋겠어요.', en:'It was my first time running a booth, and the layout mattered far more than the supplies. Crowds come in waves, so staffing up at those hours worked best. Hope this helps whoever goes next.', zh:'第一次摆摊，发现动线比准备的物品重要得多。人流有固定高峰，在那时集中安排人手更好。希望对之后要办的同学有帮助。', ja:'初めてのブース運営でしたが、備品より動線がはるかに重要でした。人が集まる時間帯が決まっているので、そこに人員を寄せるのが正解でした。次にやる方の参考になれば。'} },
  { id:'cp04', community:'it',     author:3, hours:1,  like:12, comment:5,  title:{ko:'알고리즘 스터디 같이 하실 분 계신가요',en:'Anyone up for an algorithm study group?',zh:'有人一起参加算法学习小组吗',ja:'アルゴリズムスタディを一緒にやりませんか'}, body:{ko:'주 2회, 저녁 시간대로 생각하고 있습니다. 백준 기준으로 실버 정도면 함께 하기 좋을 것 같아요. 장소는 학교 근처 스터디룸이나 온라인 둘 다 열어 두고 있습니다.', en:'Thinking twice a week in the evenings. Silver tier on Baekjoon is a comfortable starting point. Open to either a study room near campus or fully online.', zh:'计划每周两次，晚上时段。Baekjoon白银水平即可参加。地点可以是学校附近的自习室，也可以线上。', ja:'週2回、夕方の時間帯を考えています。Baekjoonのシルバー程度なら一緒にやりやすいと思います。場所は学校近くのスタディルームでもオンラインでも構いません。'} },
  { id:'cp05', community:'it',     author:0, hours:9,  like:27, comment:16, title:{ko:'첫 백엔드 인턴 면접 후기 남깁니다',en:'Notes from my first backend internship interview',zh:'第一次后端实习面试后记',ja:'初めてのバックエンドインターン面接のレビュー'}, body:{ko:'기술 질문보다 프로젝트에서 무엇을 왜 그렇게 결정했는지를 훨씬 깊게 물어보셨어요. 코드를 외우기보다 선택의 이유를 정리해 가는 게 도움이 됐습니다. 분위기는 생각보다 편했어요.', en:'They dug into why I made each decision in my project far more than into technical trivia. Preparing the reasoning behind my choices helped more than memorizing code. The mood was more relaxed than expected.', zh:'比起技术问题，他们更深入地追问项目中为什么这样决定。整理选择的理由比背代码更有用。氛围比想象中轻松。', ja:'技術的な質問より、プロジェクトで何をなぜそう決めたのかを深く聞かれました。コードを覚えるより選択の理由を整理していくのが役立ちました。雰囲気は思ったより和やかでした。'} },
  { id:'cp06', community:'it',     author:2, hours:30, like:15, comment:4,  title:{ko:'해커톤 팀 구성할 때 뭘 먼저 정하나요?',en:'What do you decide first when forming a hackathon team?',zh:'组黑客松队伍时先定什么？',ja:'ハッカソンのチーム編成で最初に決めることは？'}, body:{ko:'역할부터 정하면 아이디어가 그 틀에 갇히더라고요. 저희는 만들 것을 먼저 좁히고 역할을 나눴을 때가 제일 잘 굴러갔습니다. 다른 분들은 어떻게 하시는지 궁금해요.', en:'Assigning roles first tends to box the idea in. Our best runs came from narrowing what to build, then splitting roles. Curious how others approach it.', zh:'先定角色反而会限制创意。我们先确定要做什么再分工时进行得最顺利。想知道大家都怎么做。', ja:'役割から決めるとアイデアがその枠に収まってしまいます。作るものを先に絞ってから役割を分けたときが一番うまくいきました。皆さんはどうしていますか。'} },
  { id:'cp07', community:'design', author:1, hours:3,  like:22, comment:8,  title:{ko:'졸업작품 준비 팀 공유합니다!',en:'Sharing our capstone project team!',zh:'分享我们的毕业设计团队！',ja:'卒業作品準備チームをシェアします！'}, body:{ko:'기획 한 명, 디자인 두 명으로 시작해서 지금은 개발까지 다섯 명입니다. 매주 수요일 저녁에 모여 진행 상황을 공유하고 있어요. 궁금한 점 있으면 편하게 물어보세요.', en:'We started with one planner and two designers, and now we are five including developers. We meet Wednesday evenings to share progress. Ask anything.', zh:'从一名企划、两名设计开始，现在加上开发共五人。每周三晚上碰面同步进度。有问题欢迎提问。', ja:'企画1名、デザイン2名で始めて、今は開発を含めて5名です。毎週水曜の夜に集まって進捗を共有しています。気軽に質問してください。'} },
  { id:'cp08', community:'design', author:3, hours:12, like:19, comment:7,  title:{ko:'포트폴리오 첫 장 어떻게 구성하셨어요?',en:'How did you lay out your portfolio cover?',zh:'作品集第一页你们怎么排的？',ja:'ポートフォリオの1ページ目はどう構成しましたか？'}, body:{ko:'첫 장은 결국 이 사람이 무엇을 하는 사람인지 한 줄로 보여주는 자리 같아요. 저는 대표 작업 하나와 한 문장만 남기는 쪽으로 정리했습니다. 여러 개를 넣었을 때보다 반응이 좋았어요.', en:'The cover really just answers what kind of designer you are in one line. I cut mine down to one signature piece and a single sentence, and it landed better than a grid of everything.', zh:'第一页说到底就是用一句话说明你是做什么的。我最后只留了一件代表作和一句话，反响比放很多作品更好。', ja:'1ページ目は結局、自分が何をする人かを一行で示す場所だと思います。代表作を一つと一文だけに絞ったところ、たくさん載せたときより反応がよかったです。'} },
  { id:'cp09', community:'contest',author:0, hours:5,  like:33, comment:12, title:{ko:'공모전 수상 후 상금 지급까지 얼마나 걸렸나요',en:'How long until prize money arrives after winning?',zh:'获奖后奖金多久到账？',ja:'受賞後、賞金の支払いまでどれくらいかかりましたか'}, body:{ko:'저는 발표 후 두 달쯤 걸렸습니다. 서류를 늦게 내면 그만큼 밀리니 안내 메일 오면 바로 처리하시는 걸 추천해요. 주최 측마다 차이가 크다고 들었습니다.', en:'Mine took about two months after the announcement. Paperwork delays push it back, so handle the email as soon as it arrives. I hear it varies a lot by organizer.', zh:'我是公布后大约两个月到账。材料交晚就会顺延，建议收到邮件就马上办。听说各主办方差别很大。', ja:'私は発表から2か月ほどかかりました。書類を出すのが遅れるとその分ずれるので、案内メールが来たらすぐ対応するのがおすすめです。主催者によって差が大きいようです。'} },
  { id:'cp10', community:'contest',author:2, hours:20, like:16, comment:6,  title:{ko:'서류 탈락만 세 번째인데 조언 구합니다',en:'Rejected at the document stage three times — advice?',zh:'已经三次书面落选，求建议',ja:'書類選考で3回落ちました。アドバイスをください'}, body:{ko:'같은 형식으로 계속 낸 게 문제였던 것 같아 이번엔 기획 의도부터 다시 썼습니다. 혹시 서류에서 무엇을 가장 크게 보신다고 느끼셨는지 조언 부탁드려요.', en:'I think submitting the same format over and over was the problem, so I rewrote the concept from scratch. What did you feel mattered most at the document stage?', zh:'一直用同样的格式提交可能是问题所在，这次我从企划意图重新写起。想请教书面评审最看重什么。', ja:'同じ形式で出し続けたのが問題だと思い、今回は企画意図から書き直しました。書類選考で何が一番見られていると感じましたか。'} },
  { id:'cp11', community:'study',  author:1, hours:4,  like:14, comment:10, title:{ko:'토익 스터디 인원 두 자리 남았어요',en:'Two spots left in our TOEIC study group',zh:'托业学习小组还剩两个名额',ja:'TOEICスタディ、残り2席です'}, body:{ko:'평일 저녁 두 번, 주말 오전 한 번으로 진행합니다. 목표 점수는 각자 달라도 되고 출석만 지켜 주시면 됩니다. 관심 있으시면 댓글 남겨 주세요.', en:'Two weekday evenings and one weekend morning. Target scores can differ; just keep attendance. Comment if you are interested.', zh:'平日晚上两次，周末上午一次。目标分数可以不同，只要保证出勤。有兴趣请留言。', ja:'平日の夜2回、週末の午前1回で進めます。目標点は人それぞれで構いません、出席だけ守ってください。興味があればコメントください。'} },
  { id:'cp12', community:'study',  author:3, hours:33, like:11, comment:3,  title:{ko:'스터디 벌금 제도 효과 있나요?',en:'Do study-group penalty fees actually work?',zh:'学习小组的罚款制度有用吗？',ja:'スタディの罰金制度は効果ありますか？'}, body:{ko:'금액이 크면 부담스러워서 오히려 안 나오게 되더라고요. 저희는 소액으로 하되 모인 돈을 마지막 날 같이 쓰는 방식으로 바꿨더니 출석률이 올랐습니다.', en:'Large fines just made people skip. We switched to a small amount and spent the pot together on the last day, and attendance went up.', zh:'罚金太高反而让人干脆不来。我们改成小额，最后一天把攒下的钱一起用掉，出勤率反而上升了。', ja:'金額が大きいと負担で逆に来なくなります。少額にして、集まったお金を最終日に一緒に使う方式に変えたら出席率が上がりました。'} },
  { id:'cp13', community:'startup',author:2, hours:6,  like:20, comment:9,  title:{ko:'교내 창업지원단 상담 받아봤습니다',en:'I visited the campus startup support center',zh:'去了校内创业支援团咨询',ja:'学内の起業支援団に相談してきました'}, body:{ko:'사업계획서 초안을 들고 갔는데 시장 규모부터 다시 보라는 이야기를 들었습니다. 무료인데 피드백이 꽤 구체적이었어요. 창업 생각 있으시면 한 번 가 보시길 권합니다.', en:'I brought a draft business plan and was told to rethink the market size first. It is free and the feedback was concrete. Worth a visit if you are considering a startup.', zh:'带着商业计划书初稿去，被建议先重新看市场规模。免费而且反馈相当具体，有创业想法的可以去一次。', ja:'事業計画書の草案を持って行ったところ、市場規模から見直すよう言われました。無料なのにフィードバックがかなり具体的でした。起業を考えているなら一度どうぞ。'} },
  { id:'cp14', community:'photo',  author:0, hours:8,  like:25, comment:5,  title:{ko:'교정 야경 찍기 좋은 자리 추천',en:'Best spots for campus night photography',zh:'推荐校园夜景拍摄地点',ja:'キャンパスの夜景撮影におすすめの場所'}, body:{ko:'본관 뒤편 계단에서 보면 조명이 겹쳐서 예쁘게 나옵니다. 삼각대는 있는 게 좋고, 10시 이후에는 소등되니 그 전에 가시는 걸 추천해요.', en:'The stairs behind the main hall layer the lights nicely. Bring a tripod, and go before 10pm when they switch the lights off.', zh:'在主楼后面的台阶上拍，灯光层次很好看。最好带三脚架，十点后熄灯，建议早点去。', ja:'本館裏の階段から見ると照明が重なってきれいに写ります。三脚はあった方がよく、22時以降は消灯するのでその前に行くのがおすすめです。'} },
  { id:'cp15', community:'music',  author:1, hours:15, like:13, comment:6,  title:{ko:'합주실 예약 어떻게 하시나요',en:'How do you book the practice room?',zh:'合奏室怎么预约？',ja:'リハーサル室の予約はどうしていますか'}, body:{ko:'홈페이지 예약 시스템이 있는데 매주 월요일 0시에 열립니다. 인기 시간대는 금방 차서 미리 로그인해 두는 게 좋아요. 취소분이 종종 나오니 자주 확인해 보세요.', en:'Booking opens on the site at midnight every Monday. Popular slots go fast, so log in beforehand. Cancellations do show up, so keep checking.', zh:'官网有预约系统，每周一零点开放。热门时段很快被订满，建议提前登录。经常有人取消，可以多刷新看看。', ja:'ホームページに予約システムがあり、毎週月曜の0時に開きます。人気の時間帯はすぐ埋まるので事前にログインしておくとよいです。キャンセルもよく出るのでこまめに確認を。'} },
  { id:'cp16', community:'travelcamp',author:3,hours:11,like:17, comment:8, title:{ko:'2박 3일 제주 예산 짜봤어요',en:'Budget plan for a 3-day Jeju trip',zh:'做了济州三天两夜的预算',ja:'2泊3日の済州島の予算を組んでみました'}, body:{ko:'숙소는 게스트하우스 기준 1인 2만원대, 렌터카는 셋이 나누면 하루 1만원 정도였습니다. 식비를 넉넉히 잡아도 30만원 안쪽으로 정리되더라고요.', en:'Guesthouse beds ran about 20,000 KRW a night, and a rental car split three ways came to roughly 10,000 KRW a day. Even with a generous food budget it stayed under 300,000 KRW.', zh:'住宿按青旅算每人两万韩元左右，租车三人分摊每天约一万韩元。餐费算宽裕些，总共也在三十万韩元以内。', ja:'宿はゲストハウスで1人2万ウォン台、レンタカーは3人で割って1日1万ウォンほどでした。食費を多めに見ても30万ウォン以内に収まりました。'} },
  { id:'cp17', community:'marketing',author:2,hours:18,like:12, comment:4,  title:{ko:'서포터즈 활동 시간 얼마나 드나요',en:'How much time do supporter programs take?',zh:'支持者活动要花多少时间？',ja:'サポーターズ活動はどのくらい時間がかかりますか'}, body:{ko:'주 2회 콘텐츠 업로드에 월 1회 오프라인 미팅이 있었습니다. 과제 자체는 어렵지 않은데 마감이 촘촘해서 시간표와 겹치는지 먼저 확인해 보시는 걸 권해요.', en:'Two content uploads a week plus one offline meeting a month. The tasks are not hard, but deadlines are tight, so check it against your class schedule first.', zh:'每周两次内容上传，每月一次线下会议。任务本身不难，但截止很密集，建议先确认和课表是否冲突。', ja:'週2回のコンテンツ投稿と月1回のオフライン会議がありました。課題自体は難しくありませんが締切が細かいので、時間割と重ならないか先に確認を。'} },
  { id:'cp18', community:'media',  author:0, hours:22, like:10, comment:3,  title:{ko:'편집 프로그램 뭐 쓰시나요',en:'Which editing software do you use?',zh:'你们用什么剪辑软件？',ja:'編集ソフトは何を使っていますか'}, body:{ko:'무료로 시작하실 거면 다빈치 리졸브를 추천합니다. 처음엔 복잡해 보여도 컷 편집 정도는 금방 익숙해져요. 무거우면 캡컷으로 시작하셔도 충분합니다.', en:'If you want to start free, I recommend DaVinci Resolve. It looks complex at first but basic cutting comes quickly. If it is too heavy, CapCut is plenty to begin with.', zh:'想免费入门推荐DaVinci Resolve。开始看着复杂，但剪辑很快就能上手。嫌吃配置的话用CapCut起步也够。', ja:'無料で始めるならDaVinci Resolveをおすすめします。最初は複雑に見えても、カット編集程度ならすぐ慣れます。重ければCapCutから始めても十分です。'} },
];

/* 커뮤니티별 모집글 */
const COMM_RECRUITS = [
  { id:'cr01', community:'it',      tag:'스터디',   cur:3, max:5,  org:{ko:'IT/개발 · 서울',en:'IT/Dev · Seoul',zh:'IT/开发 · 首尔',ja:'IT/開発 · ソウル'},      title:{ko:'프론트엔드 스터디 팀원 모집',en:'Frontend Study Group Members Wanted',zh:'招募前端学习小组成员',ja:'フロントエンドスタディメンバー募集'}, desc:{ko:'리액트 공식 문서를 함께 읽고 매주 작은 화면을 하나씩 만들어 봅니다. 완성보다 꾸준함을 우선합니다.', en:'We read the React docs together and build one small screen each week. Consistency over completion.', zh:'一起读React官方文档，每周做一个小页面。比起完成度更看重坚持。', ja:'Reactの公式ドキュメントを一緒に読み、毎週小さな画面を一つ作ります。完成より継続を大切にします。'} },
  { id:'cr02', community:'it',      tag:'해커톤',   cur:2, max:4,  org:{ko:'IT/개발 · 전국',en:'IT/Dev · Nationwide',zh:'IT/开发 · 全国',ja:'IT/開発 · 全国'},     title:{ko:'ESG 해커톤 같이 나갈 팀원 구해요',en:'Looking for teammates for the ESG hackathon',zh:'招募一起参加ESG黑客松的队友',ja:'ESGハッカソンに一緒に出るメンバー募集'}, desc:{ko:'기획 한 명, 디자인 한 명이 이미 있고 개발 두 자리가 비어 있습니다. 대회 전까지 주 1회 온라인으로 모입니다.', en:'One planner and one designer are on board; two developer seats are open. We meet online once a week until the contest.', zh:'企划和设计各一人已就位，还缺两名开发。比赛前每周线上碰面一次。', ja:'企画1名、デザイン1名は決まっており、開発が2枠空いています。大会までは週1回オンラインで集まります。'} },
  { id:'cr03', community:'design',  tag:'프로젝트', cur:2, max:4,  org:{ko:'기획 · 오산대',en:'Planning · Osan Univ.',zh:'企划 · 乌山大学',ja:'企画 · 烏山大'},      title:{ko:'앱 서비스 기획 프로젝트 팀원 구해요!',en:'Looking for App Planning Project Members!',zh:'招募App服务企划项目成员！',ja:'アプリサービス企画プロジェクトメンバー募集！'}, desc:{ko:'아이디어는 정해져 있고 화면 설계부터 함께할 분을 찾습니다. 경험보다 끝까지 갈 의지를 봅니다.', en:'The idea is set; we need people to join from wireframing on. Commitment matters more than experience.', zh:'创意已定，招募从界面设计阶段开始参与的伙伴。比起经验更看重能否坚持到底。', ja:'アイデアは決まっており、画面設計から一緒に進める方を探しています。経験よりも最後までやり切る意志を重視します。'} },
  { id:'cr04', community:'marketing',tag:'대외활동',cur:5, max:10, org:{ko:'마케팅 · 전국',en:'Marketing · Nationwide',zh:'市场营销 · 全国',ja:'マーケティング · 全国'}, title:{ko:'대학생 마케팅 서포터즈 15기 모집',en:'15th College Marketing Supporters',zh:'第15期大学生市场营销支持者招募',ja:'大学生マーケティングサポーターズ15期募集'}, desc:{ko:'SNS 콘텐츠 기획과 제작을 맡게 되며 활동비가 지급됩니다. 월 1회 오프라인 정기 모임이 있습니다.', en:'You will plan and produce social content, with a stipend provided. There is one offline meetup a month.', zh:'负责社交媒体内容的策划与制作，提供活动补贴。每月一次线下例会。', ja:'SNSコンテンツの企画・制作を担当し、活動費が支給されます。月1回のオフライン定例会があります。'} },
  { id:'cr05', community:'study',   tag:'스터디',   cur:4, max:6,  org:{ko:'어학 · 오산대',en:'Language · Osan Univ.',zh:'语言 · 乌山大学',ja:'語学 · 烏山大'},      title:{ko:'토익 900점 목표 스터디원 모집',en:'TOEIC 900 target study group',zh:'招募托业900分目标学习小组',ja:'TOEIC900点目標スタディメンバー募集'}, desc:{ko:'같은 목표 점수를 향해 아침 시간에 모여 공부합니다. 문제집은 각자 준비하고 오답만 함께 봅니다.', en:'We meet in the mornings working toward the same target score. Bring your own book; we review only the mistakes together.', zh:'为相同目标分数在早晨一起学习。习题册各自准备，只一起看错题。', ja:'同じ目標点に向けて朝の時間に集まって勉強します。問題集は各自用意し、間違えた問題だけ一緒に見ます。'} },
  { id:'cr06', community:'school',  tag:'행사',     cur:8, max:15, org:{ko:'교내 · 오산대',en:'On campus · Osan Univ.',zh:'校内 · 乌山大学',ja:'学内 · 烏山大'},     title:{ko:'교내 체육대회 학과 대표팀 모집',en:'Department team for the campus sports day',zh:'招募校内运动会学科代表队',ja:'学内体育大会の学科代表チーム募集'}, desc:{ko:'학과 대표로 나갈 선수와 응원단을 함께 모집합니다. 종목은 신청 인원에 맞춰 정할 예정입니다.', en:'We are recruiting both players and cheerers to represent the department. Events will be set based on who signs up.', zh:'同时招募代表学科出战的选手和啦啦队。项目将根据报名人数确定。', ja:'学科代表として出場する選手と応援団を同時に募集します。種目は申込人数に合わせて決めます。'} },
  { id:'cr07', community:'travelcamp',tag:'번개',   cur:3, max:6,  org:{ko:'여행 · 제주',en:'Travel · Jeju',zh:'旅行 · 济州',ja:'旅行 · 済州'},                    title:{ko:'제주도 2박 3일 번개 여행 인원 모집',en:'Jeju 3-day meetup trip — join us',zh:'招募济州岛3天2夜快闪旅行成员',ja:'済州島2泊3日突発旅行メンバー募集'}, desc:{ko:'비행기표와 숙소는 각자 예약하고 일정만 함께 움직입니다. 렌터카 비용은 인원수로 나눕니다.', en:'Book your own flight and lodging; we just travel the itinerary together. Rental car costs are split by head count.', zh:'机票住宿各自预订，只是一起行动。租车费用按人数分摊。', ja:'航空券と宿は各自で予約し、行程だけ一緒に動きます。レンタカー代は人数で割ります。'} },
];
...
const INFO_PRESET = {
  ...
  '해커톤': {
    host:{ko:'산학협력단 · 후원 기업',en:'Industry-academic office & sponsors',zh:'产学合作团·赞助企业',ja:'産学協力団・協賛企業'},
    target:{ko:'2~4인 팀 단위 참가',en:'Teams of 2 to 4',zh:'2~4人组队参加',ja:'2〜4名のチーム単位'},
    method:{ko:'팀 등록 후 현장 참가',en:'Register your team, then join on site',zh:'团队报名后现场参加',ja:'チーム登録後、現地参加'},
    prize:{ko:'대상 500만원 및 부상',en:'5M KRW grand prize and more',zh:'大奖500万韩元及奖品',ja:'大賞500万ウォンと副賞'},
  },
  '문화/예술': {
    host:{ko:'교내 문화예술위원회',en:'Campus Arts Committee',zh:'校内文化艺术委员会',ja:'学内文化芸術委員会'},
    target:{ko:'누구나 관람 가능',en:'Open to everyone',zh:'任何人均可参观',ja:'どなたでも観覧可能'},
    method:{ko:'별도 신청 없이 방문',en:'Just drop by, no signup',zh:'无需申请直接参观',ja:'申込不要で来場可'},
    prize:{ko:'무료',en:'Free',zh:'免费',ja:'無料'},
    prizeKey:'fee',
  },
  /* 번개 모임은 주최도 상금도 없다 — 마지막 칸을 '비용'으로 바꿔 쓴다 */
  '번개': {
    host:{ko:'학생 자율 모임',en:'Student-run meetup',zh:'学生自主聚会',ja:'学生の自主的な集まり'},
    target:{ko:'일정이 맞는 누구나',en:'Anyone free on the date',zh:'时间合适的任何人',ja:'日程が合う方ならどなたでも'},
    method:{ko:'커뮤니티 댓글 신청',en:'Comment on the post',zh:'在社区留言报名',ja:'コミュニティのコメントで応募'},
    prize:{ko:'각자 부담 (n분의 1)',en:'Split evenly among members',zh:'费用AA制',ja:'各自負担（割り勘）'},
    prizeKey:'cost',
  },
};
...
const ViewDetail = {
  ...
  init(param){
    ...
    const info = [
      ...
      { label:t('info.' + (preset.prizeKey || 'prize')), value:ct(preset.prize), icon:'iconoir:trophy' },
    ];
